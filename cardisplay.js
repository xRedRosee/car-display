...
// let scenario1 = document.querySelector('#scenario1').addEventListener('click', function(){
//   carSpeed = 25;
//   battery = 27;
//   kmToGo = 190;
//   kmAlready = 2800;
...
// let scenario2 = document.querySelector('#scenario2').addEventListener('click', function(){
//   carSpeed = 125;
//   battery = 300;
//   kmToGo = 300;
//   kmAlready = 2900;
